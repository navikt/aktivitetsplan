...
const browsers = [
    'saucelabs:iPhone XS Simulator@12.0',
    'saucelabs:Chrome@73.0:Windows 10',
    'saucelabs:MicrosoftEdge@16.16299:Windows 10',
    'saucelabs:Samsung Galaxy Tab S3 GoogleAPI Emulator@8.1'
];
const pullRequest = process.env.TRAVIS_PULL_REQUEST || false;
const branch = pullRequest ? process.env.TRAVIS_PULL_REQUEST_BRANCH : process.env.TRAVIS_BRANCH || 'Local';
