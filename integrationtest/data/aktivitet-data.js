const { getRelativeDatePrettyPrint, toDatePrettyPrint } = require('../date-utils');
...
class StillingsAktivitet extends AktivitetData {
...
class JobbrettetAktivitet extends AktivitetData {
    constructor(tittel, fraDato, tilDato) {
...
class MoteMedNavAktivitet extends AktivitetData {
    constructor(
        tittel,
        dato,
        klokkeslett,
...
class SokeJobberAktivitet extends AktivitetData {
    constructor(
        fraDato,
        tilDato,
        antallSoknader,
...
class MedisinskBehandlingAktivitet extends AktivitetData {
    constructor(
        behandlingsType,
        behandlingsSted,
        fraDato,
...
class ArenaAktivitet extends AktivitetData {
    constructor(
        tittel,
        fraDato,
        tilDato,
