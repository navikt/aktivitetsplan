...
function HengeLasIkon() {
    return <svg id="Layer_1" className="modal-header-bilde" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 26">
        <title>Låst</title>
