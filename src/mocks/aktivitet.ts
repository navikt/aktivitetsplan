...
export const mockTestAktiviteter: VeilarbAktivitet[] = [
    wrapAktivitet({
...
export function wrapAktivitet<T extends AlleAktiviteter>(a: T): T {
    ...
    return {
        ...
        oppfolgingsperiodeId: aktivitet.oppfolgingsperiodeId || 'a1aa11a1-1aa1-4e02-8cc2-d44ef605fa33',
    } as unknown as T;
}
