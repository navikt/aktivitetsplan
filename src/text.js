...
import { selectErUnderOppfolging, selectOppfolgingStatus } from './moduler/oppfolging-status/oppfolging-selector';
import { selectErVeileder, selectIdentitetStatus } from './moduler/identitet/identitet-selector';
...
function textHOC(Component, props) {
    ...
    function Text({ id, children, avhengigheter, ...rest }) {
        return (
            <Innholdslaster avhengigheter={avhengigheter} visChildrenVedFeil={visChildrenVedFeil}>
