...
export enum EksternAktivitetType {
    ...
    TILPASSET_JOBBSTOTTE = 'TILPASSET_JOBBSTOTTE', //Slettes når databasen er ryddet i dev
    VARIG_TILRETTELAGT_ARBEID_ORDINAER = 'VARIG_TILRETTELAGT_ARBEID_ORDINAER',//Slettes når databasen er ryddet i dev
