...
import UnsafeHtml from '../../felles-komponenter/unsafe-html';
            ...
            <div className="ny-aktivitet-modal side-innhold">
                ...
                {visVilkar && (
                    <div className="vis-vilkar ny-aktivitet-modal__header">
                        <Bilde
                            ...
                            src="/aktivitetsplan/img/legg-til-aktivitet-illustrasjon.svg"
                ...
                { visGodkjenning && (
                    <div>
                        ...
                        <div className="vis-vilkar">
                            <Hovedknapp onClick={this.godta} disabled={!this.state.checked}><FormattedMessage id="vilkar.ga-til-aktivitetsplan" /></Hovedknapp>
                        </div>
                    </div>
                )}
            </div>
...
const mapDispatchToProps = (dispatch) => ({
    doGodtaVilkar: () => godtaVilkar()(dispatch),
