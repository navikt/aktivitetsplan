...
export function godtaVilkar(hash) {
    return postAsJson(`${OPPFOLGING_PROXY_BASE_URL}/oppfolging/godta/${hash}`);
}

export function avslaaVilkar(hash) {
    return postAsJson(`${OPPFOLGING_PROXY_BASE_URL}/oppfolging/avslaa/${hash}`);
}

export function hentVilkar() {
    return fetchToJson(`${OPPFOLGING_PROXY_BASE_URL}/oppfolging/vilkar`);
}

export function hentHistoriskeVilkar() {
    return fetchToJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/hentVilkaarStatusListe`
    );
}
...
export function hentMalListe() {
    return fetchToJson(`${OPPFOLGING_PROXY_BASE_URL}/oppfolging/malListe`);
}

export function lagreMal(mal) {
    return postAsJson(`${OPPFOLGING_PROXY_BASE_URL}/oppfolging/mal`, mal);
}
...
export function startOppfolging() {
    return postAsJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/startOppfolging`
    );
}

export function startEskalering(dialogId, begrunnelse) {
    return postAsJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/startEskalering/`,
...
export function stoppEskalering(begrunnelse) {
    return postAsJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/stoppEskalering/`,
        { begrunnelse }
    );
}
...
export function kanAvslutte() {
    return fetchToJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/avslutningStatus`
    );
}

export function avsluttOppfolging(begrunnelse, veilederId) {
    return postAsJson(
        `${OPPFOLGING_PROXY_BASE_URL}/oppfolging/avsluttOppfolging`,
