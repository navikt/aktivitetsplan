            ...
            >
                <ModalContainer className="informasjon-modal-container">
                    ...
                    <p>
                        ...
                        aktivitetsplanen aktivt. Du må gjennomføre de aktivitetene du avtaler med NAV i planen.
                    </p>
                    <p>
                        Du kan selv legge inn og redigere målet ditt, aktiviteter du skal gjøre og stillinger du vil
                        søke på. Du får også tilgang til en dialog der du kan kommunisere med veilederen din og
                        diskutere aktiviteter du skal gjennomføre.
                    </p>
                    <Video />
                    <Ekspanderbartpanel tittel="Slik bruker du planen" border>
                        <p>
                    ...
                    <Ekspanderbartpanel tittel="Aktivitetsplanen og økonomisk støtte" border>
                        <p>
                        ...
                        <ul>
                            <li>
                                Bruk nav.no til å finne svar på disse spørsmålene. Hvis du ikke finner svaret der, kan
                                du ringe oss på 55 55 33 33.
                            </li>
                            <li>
                                Hvis du ikke følger opp avtalte aktiviteter, kan det få konsekvenser for oppfølgingen du
                                får fra NAV og eventuell økonomisk støtte.
                            </li>
                        </ul>
                    </Ekspanderbartpanel>

                    <Ekspanderbartpanel tittel="Meldekort" border>
                        <p>
                        ...
                        <p>
                            Her kan du lese{' '}
                            <a href="https://www.nav.no/no/Person/Arbeid/Dagpenger+ved+arbeidsloshet+og+permittering/Meldekort+hvordan+gjor+du+det">
