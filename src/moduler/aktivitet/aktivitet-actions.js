...
export function oppdaterSoknadsstatus(aktivitetId, aktivitetVersjon, soknadsstatus) {
    return doThenDispatch(() => Api.oppdaterSoknadsstatus(aktivitetId, aktivitetVersjon, soknadsstatus), {
        OK: AT.OPPDATER_OK,
        FEILET: AT.OPPDATER_FEILET,
        PENDING: AT.OPPDATER,
    });
