    ...
    return (
        <form onSubmit={state.onSubmit(onSubmit)} autoComplete="off" noValidate>
            <SkjemaGruppe className="aktivitetskjema">
                ...
                <Input disabled={avtalt} label="Type behandling *" {...state.fields.behandlingType} hidden={false} />
                <Input disabled={avtalt} label="Behandlingssted *" {...state.fields.behandlingSted} hidden={false} />
                ...
                <Input disabled={avtalt} label="Mål for behandlingen" {...state.fields.effekt} hidden={false} />
                <Input
                    disabled={avtalt}
