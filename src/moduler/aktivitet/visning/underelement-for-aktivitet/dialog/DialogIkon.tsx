...
function DialogIkonUtenUleste() {
    return (
        <svg className={styles.dialogIkonUtenUleste} xmlns="http://www.w3.org/2000/svg" width="24" height="24">
...
function DialogIkonMedUleste(props: Props) {
    ...
    return (
        <div>
            <svg className={styles.dialogIkonMedUleste} xmlns="http://www.w3.org/2000/svg" width="40" height="32">
                <svg y="8">
                    <path
                        fill="#0067C5"
