        ...
        >
            <FormProvider {...handlers}>
                ...
                <ReadMore header="Les om deling av CV">
                    Arbeidsgiveren får tilgang til CV-en dersom du gir aksept til å dele og Nav deler den til arbeidsgiveren. En delt CV vil opphøre å eksistere for arbeidsgiver dersom du ikke lenger følges opp av Nav for å skaffe jobb, eller senest seks måneder etter at Nav sendte CV-en til arbeidsgiver.
                    <br/><br/>
