...
function Aktivitetvisning({ aktivitet, tillatEndring, laster, underOppfolging }) {
    ...
    return (
        <div>
            <ModalContainer className="aktivitetvisning">
                ...
                <ReferatContainer aktivitet={aktivitet} underOppfolging={underOppfolging} />

                <Statusadministrasjon aktivitet={aktivitet} arenaAktivitet={arenaAktivitet} />

                <UnderelementerForAktivitet aktivitet={aktivitet} className="aktivitetvisning__underseksjon" />
            </ModalContainer>
        </div>
    );
}
