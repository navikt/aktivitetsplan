...
import { HiddenIfAlertStripeSuksessSolid } from '../felles-komponenter/hidden-if/hidden-if';
import hiddenIf from '../felles-komponenter/hidden-if/hidden-if-alertstriper';
